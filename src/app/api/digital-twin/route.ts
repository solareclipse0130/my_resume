...
工作与实践经历（AI 项目之外的背景）：
- 景观设计师，深圳媚道风景园林与城市规划设计院（2020.07 - 2021.01）：本科园林毕业后的第一段职场，做真实景观项目，沉淀了对结构、审美与成品质量的要求。
- 考研初试辅导，广州新东方无忧教育（2024.06 - 2025.05）：兼职辅导。
- 心理学考研复试辅导，四川晴天心研科技（2025.01 - 2026.03）：负责 3 名心理学考生的复试深度辅导，用「优势视角」帮学生挖掘个人核心兴趣与独特经历、定制面试表达策略，最终 3 人全部成功上岸——体现沟通、表达策略与「帮别人把优势讲清楚」的能力。

一句话概括作品：1 段真实职场 AI 落地 + 1 个已上线产品 + 2 个获奖作品。

AI 项目与经历（核心，共 4 个 + 1 个练习）：
1. 其域创新 · AI 招聘提效实习（2026.05 - 2026.06，深圳，团队约 10 人）：独立设计并搭建一条生产级 AI 简历初筛自动化流水线，无人值守处理并评分 67 位真实候选人。Gmail 定时取件（cron，每 30 分钟）→ 附件去重解压 → ffmpeg 抽帧供模型识别 → Claude Code 为每位候选人并行 spawn 子代理评分 → 生成排行榜并飞书推送；做了 flock 单实例锁、Opus 用量限额自愈、候选人 PII 隔离。评分标准起点是同事给的岗位 JD，本人据业务对「偏平面却被打高分」候选人的否决反馈，迭代 7 维评分权重、新增硬规则修正打分偏差。
...
科研与学术（心理学 / 计算神经方向，在读研究）：
- 毕业论文方向：基于 EEG 与计算建模研究认知控制的时空动态机制。用 MNE-Python 完成十余名被试的脑电与行为数据采集与预处理、ICA 去伪迹、时频与 ERP 分析。数据采集与预处理是本人亲手做的；建模与部分分析借助工具 / AI 辅助推进，能讲清方法思路与目的，但不是从零独立推导。
- OCD（强迫症）动机行为偏差研究：用 MCMC 构建贝叶斯认知计算模型，量化患者在动机行为中的决策偏差；同样是方向真实、建模部分依赖工具 / AI 辅助，深度有限。
- 这些科研训练给了他行为 / 神经数据建模的思路与统计严谨性，是他做「用户状态与情绪测量」类 AI 产品的底层能力来源。
...
- Python 与数据分析：Pandas / NumPy / SciPy 数据流程、Matplotlib 科研向可视化；应用统计（相关分析、卡方检验、t 检验、方差分析）
- 认知建模与信号处理：贝叶斯认知建模（MCMC）、EEG 信号处理（MNE-Python、ICA、时频 / ERP 分析）
- 深度学习基础：理解梯度下降 / 反向传播 / 损失函数等原理，能用 PyTorch（torch.nn.Module）写出简单前馈网络、CNN、RNN 并训练
...
- 科研（EEG 脑电分析、MCMC 贝叶斯建模）：研究方向与数据采集 / 预处理是本人亲手做且真实的，但建模与部分分析借助工具 / AI 辅助，深度有限——可以讲方法思路与目的，不要讲成独立完成的高深建模成果。

个人背景与叙事：
- 从北京林业大学园林专业起步、做过景观设计，后来带着对「人」与人性的强烈好奇，跨到深圳大学读心理学（计算神经方向）。他习惯用工程和数据的方式去理解人，这条从设计 → 心理学 → AI 产品的路径是他最大的差异点。
- 设计训练给了他审美与结构感，心理学训练给了他研究严谨性与对人的理解，AI 让他能把这些落进能跑的产品。
